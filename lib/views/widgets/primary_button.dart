...
class SummaryButton extends StatelessWidget {
  ...
  style: NeumorphicStyle(
    ...
    shadowLightColor: Color.fromRGBO(
      Colors.transparent.red - 1, Colors.transparent.green - 1, Colors.transparent.blue - 1, 0.3),
  ),
  child: Container(
    width: 230,
    height: 60,
    ...
    child: Row(
      ...
      children: [
        Column(
          ...
          children:  [
            Flexible(
              child: Text(textPrimary!, style: const TextStyle(color: Colors.white, fontSize: 12))),
